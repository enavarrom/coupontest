...
_NOTA: Este proyecto tiene una integración con una API para consultar los precios de los items. 
Se debe configurar una variable de entorno con la URL de esa api._
